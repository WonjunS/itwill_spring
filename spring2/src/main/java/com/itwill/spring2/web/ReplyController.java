...
public class ReplyController {
    ...
    public ResponseEntity<List<ReplyReadDto>> read(@PathVariable("postId") long postId) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ReplyReadDto> readById(@PathVariable("id") long id) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Integer> deleteReply(@PathVariable("id") long id) {
